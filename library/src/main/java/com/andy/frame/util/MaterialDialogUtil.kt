...
class MaterialDialogUtil {
    ...
    fun showNormal(
        ...
        if (mActivity != null && !mActivity!!.isFinishing) {
            ...
            builder.setTitle(title)
                ...
                .setNegativeButton(lBtnText, lBtnClickListener)
    ...
    fun getBuilder(): MaterialAlertDialogBuilder {
        return MaterialAlertDialogBuilder(mActivity, R.style.AD_MaterialDialogTheme)
    }
}